...
for i in range(total_Q):
    ...
    while lives>0:
        ...
        if answer == correct:
            ...
            lives -= 1
            print("WRONG!GET IT RIGHT! Ơ̸̢̢̤̙̠̘̣͓̤̝̻̙̓̐͛̏̀̒͝ͅŘ̸̨̡̥̙̰̯̼̪̰̠͖̬̙͓͍̊̐̑̇̋̔̇̑͘ ̷̡̢̛̲͙̰̣̉̀̒Ẽ̶̡̮̭͈̙̙̻͉̬̗̺̜̤̣͒̾L̸̢̯͙͚̼͇͖̰̹̓̌̈́̀̀̉̅̉̒Ș̶̨̖̗̘̠͕̩̼͕̄̓̇͐͗̅̎̀̈́̕͠͝ͅȨ̵̥̝͐̋́̊̋͝ ")
